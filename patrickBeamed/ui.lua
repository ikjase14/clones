...
if not isfile("beamed.solutions") then
...
WaterMarkLabel.Text = 'beamed.solutions<font color="rgb(74, 74, 74)"></font> - uid: <font color="rgb(74, 74, 74)">' .. uid .. '</font> / fps: <font color="rgb(147,112,219)">' .. fpsValue .. '</font> / ping: <font color="rgb(147,112,219)">' .. ping .. '</font> / time: <font color="rgb(147,112,219)">' .. time .. '</font>'
end
end)
return Watermark
end
...
local library = {
Title = 'beamed.solutions<font color="rgb(74, 74, 74)"></font> | Private',
...
menu.Name = "beamed.solutions_gui"
...
CloneScreenGui.Name = "beamed.solutions_gui"
        ...
        function library:Tween(...) TweenService:Create(...):Play() end
            function library:addTab(name,image)
                ...
                local function updateScroll()
                    ...
                    local nx = (Mouse.X - button.AbsolutePosition.X) / button.AbsoluteSize.X
                ...
                function contains(list, x)
                    for _, v in pairs(list) do
                        ...
                        writefile("beamed.solutions/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                ...
                local tbl = {}
                for i,v in next, listfiles("beamed.solutions") do table.insert(tbl,v) end
